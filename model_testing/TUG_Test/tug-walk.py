...
while cap.isOpened():
    ...
    # ================= WALK BACKWARD =================
        ...
        if walk_started_backward:
            if elapsed >= BACKWARD_WINDOW or len(hip_positions) > 50:
                print("Backward phase complete")
                state = "DONE"
...
print("Temporal walking performance evaluated against age-related reference values.")
